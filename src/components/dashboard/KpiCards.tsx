  ...
  return (
    <div className="bg-card rounded-xl p-6 shadow-card border border-border animate-fade-in" style={{ animationDelay: "0.1s" }}>
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="font-semibold text-card-foreground">Custo por Licença</h3>
      </div>
      <div className="space-y-3">
        ...
        <p className="text-xs text-muted-foreground mt-2 italic">
          O custo por licença depende da ferramenta contratada.
        </p>
      </div>
    </div>
  );
      ...
      <div className="flex items-center justify-center py-2">
        <div className="relative w-32 h-32">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <span className="text-3xl font-bold text-card-foreground">{progress}%</span>
